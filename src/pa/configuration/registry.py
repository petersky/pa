...
_DEFINITIONS = (
    ...
    _s(
        ...
        "str",
        "openai",
        "OpenAI-compatible provider label for semantic card summaries.",
        "Card summaries",
        10,
        "Changes summary provenance and the provider endpoint contract.",
        validator="non_empty",
    ),
    _s(
        "card_summary_model",
        "str",
        "gpt-5-mini",
        "Model used for semantic card summaries.",
        "Card summaries",
        20,
        "Changes summary quality, latency, and provider cost.",
        validator="non_empty",
    ),
    _s(
        ...
        "OpenAI-compatible card-summary API base URL.",
        "Card summaries",
        30,
        "Routes card content and credentials to this provider endpoint.",
        validator="http_url",
    ...
    _s(
        ...
        "str",
        "",
        "Dedicated card-summary provider API key.",
        "Secrets",
        40,
        "Authenticates direct card-summary provider requests.",
        scope="secret",
        exposure="hidden",
        secret=True,
        validator="secret",
        rationale="Secret values are write-only and redacted from every read surface.",
    ),
    _s(
        "card_summary_auth_source",
        "str",
        "dedicated",
        "Credential source for card-summary provider requests.",
        "Card summaries",
        40,
        "Selects either the dedicated secret or an explicitly configured Codex credential.",
